...
public class UserService {
	...
	public void register(RegisterRequest registerRequest) {
		...
		Role role = roleRepository.findByName(RoleType.ROLE_CUSTOMER).orElseThrow(() -> new ResourceNotFoundExeption(
	...
	public void updateUser(Long id, UserUpdateRequest userUpdateRequest) {
		...
		userRepository.update(id, userUpdateRequest.getFirstName(),userUpdateRequest.getLastName(),userUpdateRequest.getPhoneNumber(),
				userUpdateRequest.getEmail(),userUpdateRequest.getZipCode(),userUpdateRequest.getAddress());
	}
    ...
    public Set<Role> convertRoles(Set<String> pRoles){
    	...
    	if(pRoles == null) {
    		Role userRole = roleRepository.findByName(RoleType.ROLE_CUSTOMER).orElseThrow(()-> 
    		new ResourceNotFoundExeption(String.format(ErrorMessage.ROLE_NOT_FOUND_MESSAGE, RoleType.ROLE_CUSTOMER.name())));
    		...
    		pRoles.forEach(role->{
				...
				case "Administrator": 
		    		...
		    		new ResourceNotFoundExeption(String.format(ErrorMessage.ROLE_NOT_FOUND_MESSAGE, RoleType.ROLE_ADMIN.name())));
					roles.add(adminRole);
				default:
		    		Role userRole = roleRepository.findByName(RoleType.ROLE_CUSTOMER).orElseThrow(()-> 
		    		new ResourceNotFoundExeption(String.format(ErrorMessage.ROLE_NOT_FOUND_MESSAGE, RoleType.ROLE_CUSTOMER.name())));
